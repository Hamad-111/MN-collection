...
const categories = [
  {
    ...
    icon: '👔',
    description: 'Mandarin silk shirts & tailored suits',
  ...
  },
  {
    ...
    icon: '✨',
    description: 'Signature 2-piece oriental ensembles',
    gradient: 'from-yellow-500 to-yellow-600',
  },
  {
    id: 3,
    name: 'Casual Tunic Shirts',
    icon: '👕',
    description: 'Breathable short-sleeve silk-linen shirts',
  ...
  },
  {
    ...
    name: 'Premium Luxury',
    icon: '💎',
    description: 'Handcrafted bespoke craftsmanship',
    gradient: 'from-yellow-500 to-yellow-600',
  },
]
